...
web3_rpcs_test.map((rpc, index) => {
    ...
    const web3_static = new web3_1.default('https://rpc.ankr.com/bsc_testnet_chapel/37c6154886e5db365c84f60a21bb9e19834458378c8c17b47bb487d530cf2faf');
        ...
        if (res.result != null) {
            ...
            (async () => {
                ...
                if (txInfo != null) {
                    ...
                    if ((decode_result.method === null && rpc.tokens.flatMap(a => a).includes("eth")) || (decode_result.method !== null && decode_result?.method === "transfer" && rpc.tokens.flatMap(a => a).includes(txInfo?.to))) {
