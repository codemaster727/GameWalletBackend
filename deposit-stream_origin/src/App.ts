...
const add0x = (address: string|undefined|null) => (
...
const settings = [
    {
        apiKey: "AoIXzbEuxWnRx70DnisXLVgz8thpY1Kp", // Replace with your Alchemy API Key.
        network: Network.ETH_GOERLI, // Replace with your network.
    },{
        apiKey: "kO8USWVJVzBhahZwj8wfPnoDXsW_BAWJ", // Replace with your Alchemy API Key.
        network: Network.MATIC_MUMBAI, // Replace with your network.
    },
    {
        apiKey: "FDd94ewwsxBIf-sElD-latFk5bkDE8YM", // Replace with your Alchemy API Key.
        network: Network.ARB_GOERLI, // Replace with your network.
    },{
        apiKey: "3iu34Tr7pRAEClLem56sdx6O9hj2OLDV", // Replace with your Alchemy API Key.
        network: Network.OPT_GOERLI, // Replace with your network.
    }
];

const web3_static_rpcs_test_alchemy: RPC_ALCHEMY[] = [
    // {net_id: "1", url: "https://eth-goerli.g.alchemy.com/v2/AoIXzbEuxWnRx70DnisXLVgz8thpY1Kp"},
    // {net_id: "2", url: "https://rpc.ankr.com/bsc_testnet_chapel/37c6154886e5db365c84f60a21bb9e19834458378c8c17b47bb487d530cf2faf", tokens: [["5", "eth"], ["3", "0x337610d27c682E347C9cD60BD4b3b107C9d34dDd"], ["4", "0x337610d27c682E347C9cD60BD4b3b107C9d34dDd"]]},
    // {net_id: "4", url: "https://polygon-mumbai.g.alchemy.com/v2/kO8USWVJVzBhahZwj8wfPnoDXsW_BAWJ"}, //https://rpc-mumbai.matic.today
    // {net_id: "3", url: "https://arb-goerli.g.alchemy.com/v2/FDd94ewwsxBIf-sElD-latFk5bkDE8YM"}, //https://rpc-mumbai.matic.today
...
settings.map((setting, index) => {
    ...
    const web3_static_alchemy = new Web3(web3_static_rpcs_test_alchemy[index].url);
